...
#define PEERCHAT_MIN_KEEPALIVE 30
#define MAX_FLOOD_WEIGHT 10000
...
namespace Peerchat {
	...
	private:
		...
		void handle_cdkey(std::vector<std::string> data_parser);
		void handle_registernick(std::vector<std::string> data_parser);
