...
namespace MM {
	...
	TaskShared::ListenerArgs consume_clientmsgs_message = {mm_channel_exchange, mm_server_client_acks_routingkey, Handle_QRMessage};
	...
	void InitTasks() {
		setup_listener(&consume_clientmsgs_message);
	}
}
