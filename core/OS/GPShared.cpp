...
namespace GPShared {
	...
	GPErrorData gp_error_data[] = {
		...
		{GP_LOGIN, "There was an error logging in to the GP backend.", true},
		{GP_LOGIN_TIMEOUT, "The login attempt timed out.", true},
		{GP_LOGIN_BAD_NICK, "The nickname provided was incorrect.", true},
		{GP_LOGIN_BAD_EMAIL, "The e-mail address provided was incorrect.", true},
		{GP_LOGIN_BAD_PASSWORD, "The password provided was incorrect.", true},
		{GP_LOGIN_BAD_PROFILE, "The profile provided was incorrect.", true},
		{GP_LOGIN_PROFILE_DELETED, "The profile has been deleted.", true},
		{GP_LOGIN_CONNECTION_FAILED, "The server has refused the connection.", true},
		{GP_LOGIN_SERVER_AUTH_FAILED, "The server could not be authenticated.", true},
		{GP_LOGIN_BAD_UNIQUENICK, "The uniquenick provided was incorrect.", true},
		{GP_LOGIN_BAD_PREAUTH, "There was an error validating the pre-authentication.", true},
		{GP_LOGIN_BAD_LOGIN_TICKET, "The login ticket was unable to be validated.", true},
		{GP_LOGIN_EXPIRED_LOGIN_TICKET, "The login ticket had expired and could not be used.", true},
